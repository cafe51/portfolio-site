...
const SkillCard = ({ assetData }: SkillCardProps) => {
    return (
        <div className="flex flex-col justify-between items-center transition-transform duration-500 ease-in-out transform hover:scale-110 p-2 md:py-4 md:px-8 w-fit">
            <Image
